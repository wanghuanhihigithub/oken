...
api_key='6c4f2de6-11f5-4bc0-92d7-4bfe6f76298a'
secret_key = "D2C503E6F1BD1959BF8C9B2AA8DD7A76"
#business
...
def on_open(self):
    ...
    self.send("{'event':'addChannel','channel':'ok_sub_spot_usd_btc_ticker','binary':'true'}")
